load_balancers = {
  lb = {
    ...
    frontend_ip_configuration = {
      feipc1 = {
        # name   = "" # Optional: Override the auto-generated frontend IP configuration name (default: <lb-name>-<key>-lbfe)
    ...
    # backend_address_pool_name = "" # Optional: Override the auto-generated backend address pool name (default: <lb-name>-HA-lbbp)
    ...
    probes = {
      tcp443 = {
        # name            = ""    # Optional: Override the auto-generated probe name (default: <lb-name>-<key>-lbhp)
    ...
    # Note: enable_floating_ip / enable_tcp_reset are mapped internally to the
    # azurerm v5 provider attribute names floating_ip_enabled / tcp_reset_enabled.
    # Keys below are unchanged for callers.
    #
    rules = {
      tcp443 = {
        # name                           = ""        # Optional: Override the auto-generated rule name (default: <lb-name>-<key>-lbr)
